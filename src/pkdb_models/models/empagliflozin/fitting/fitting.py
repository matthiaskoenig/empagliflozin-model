"""Empagliflozin parameter fitting."""
import logging
...
from pkdb_models.models.empagliflozin.fitting.fit_experiments import (
    f_fitexp_all,
    f_fitexp_control,
    f_fitexp_pd,
    f_fitexp_pk,
)
from pkdb_models.models.empagliflozin.fitting.parameters import (
    parameters_pk,
    parameters_pd,
    parameters_pk_pd,
)

from pkdb_models.models.empagliflozin import (
    EMPAGLIFLOZIN_PATH,
    DATA_PATHS,
)
...
def main() -> None:
    ...
    The script is registered as `fit_empagliflozin` command.
    """
    ...
    console.print(":wrench: FIT EMPAGLIFLOZIN :wrench:")
    console.rule(style="white")
    ...
    results: Dict[str, Tuple[OptimizationResult, OptimizationProblem]] = fit_empagliflozin(
        fit_experiments=fit_experiments,
