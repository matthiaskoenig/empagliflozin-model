...
SUBSTANCES_BODY = {
    ...
    "eg": {
        "name": "empagliflozin-glucuronide",
        "unit": U.mmole,
        # initial concentration
        "cinit": 0.0,  # [mmole/l]
        # Molecular weight
...
kidney_id = "empagliflozin_kidney"
liver_id = "empagliflozin_liver"
gut_id = "empagliflozin_intestine"
...
# --------------------------------------------------------------------------------------------------
# Total metabolites (recoveries and radioactivity)
# --------------------------------------------------------------------------------------------------
_m.species.extend(
    [
        Species(
            f"Cve_emptot",
            metaId=f"meta_Cve_emptot",
            initialConcentration=0,
            compartment="Vve",
            substanceUnit=U.mmole,
            name=f"total empagliflozin (plasma)",
            hasOnlySubstanceUnits=False,
            sboTerm=SBO.SIMPLE_CHEMICAL,
            annotations=annotations.species["emptot"],
        ),
        Species(
            f"Aurine_emptot",
            metaId=f"meta_Aurine_emptot",
            initialConcentration=0,
            compartment="Vurine",
            substanceUnit=U.mmole,
            name=f"total empagliflozin (urine)",
            hasOnlySubstanceUnits=True,
            sboTerm=SBO.SIMPLE_CHEMICAL,
            annotations=annotations.species["emptot"],
        ),
        Species(
            f"Afeces_emptot",
            metaId=f"meta_Afeces_emptot",
            initialConcentration=0,
            compartment="Vfeces",
            substanceUnit=U.mmole,
            name=f"total empagliflozin (feces)",
            hasOnlySubstanceUnits=True,
            sboTerm=SBO.SIMPLE_CHEMICAL,
            annotations=annotations.species["emptot"],
        )
...
_m.rules.extend([
    AssignmentRule(
        ...
        "Cve_emp + Cve_eg",
        unit=U.mM,
        name="Sum of empagliflozin and EG metabolite",
    ),
    AssignmentRule(
        "Aurine_emptot",
        "Aurine_emp + Aurine_eg",
        unit=U.mM,
        name="Sum of empagliflozin and EG metabolite",
    ),
    AssignmentRule(
        "Afeces_emptot",
        "Afeces_emp + Afeces_eg",
        unit=U.mM,
        name="Sum of empagliflozin and EG metabolite",
    ),
])
